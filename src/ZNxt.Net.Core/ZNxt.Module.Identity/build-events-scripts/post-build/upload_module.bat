...
rem wget -S -O uninstall_response.json --post-data "{\"Name\":\"ZNxt.Module.Identity\",\"InstallationKey\":\"49562cfc3b17139ea01c480b9c86a2ddacb38ff1b2e9db1bf66bab7a4e3f1fb5\"}" %http_base_url%/api/moduleinstaller/uninstall
 ...
 wget -S -O response.json --post-data "{\"Name\":\"ZNxt.Module.Identity\",\"Version\":\"1.0.0-Beta00%1\",\"InstallationKey\":\"f5d2ce5ed463e844266feb92abba804244a7b5287484ecd2041395dad4bf18c3\"}" %http_base_url%/api/moduleinstaller/install
