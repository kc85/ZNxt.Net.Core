...
(function () {
    ...
    var ZApp = angular.module(__ZNxtAppName, ['ngAnimate', 'ngRoute', 'psi.sortable']);
    var isloaded = false;
            ...
            response: function (response) {
                ...
                if (response.data != undefined && response.data.code != undefined) {
                    if (response.data.code == 401) {
                        ...
                        $rootScope.$broadcast('onError', { text: "Something went wrong in the server", timeout: 2000 });
